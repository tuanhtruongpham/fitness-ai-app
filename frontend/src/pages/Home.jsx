    ...
    <div style={styles.page}>
      ...
      <div style={styles.main}>
        <div style={styles.header}>
          <div>
            <h1 style={styles.title}>Good Evening, Uy 💪</h1>
        ...
        <div style={styles.statsGrid}>
          <div style={styles.card}>
            <h3>🔥 Calories</h3>
            <h1>2,450</h1>
            <p style={styles.cardText}>Daily target</p>
          </div>

          <div style={styles.card}>
            <h3>💪 Workout</h3>
            <h1>Chest Day</h1>
            <p style={styles.cardText}>5 exercises today</p>
          </div>
          ...
          <div style={styles.card}>
            <h3>📈 BMI</h3>
            <h1>22.1</h1>
            <p style={styles.cardText}>Healthy range</p>
          </div>
        </div>
